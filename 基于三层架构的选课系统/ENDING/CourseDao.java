...
public class CourseDao implements IDao,Serializable {
	...
	private CourseDao() {
		...
		course1.setCourseNo("1111");
		course1.setCourseName("日语会话");
		course1.setCourseGrade(2);
		courses.put(course1.getCourseNo(), course1);
		
		Course course2 = new Course();
		course2.setCourseNo("2222");
		course2.setCourseName("高级英语");
		course2.setCourseGrade(3);
		courses.put(course2.getCourseNo(), course2);
		
		Course course3 = new Course();
		course3.setCourseNo("3333");
		course3.setCourseName("博大汉语");
